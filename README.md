...
Для тесторования используются пакеты `godoc.org/testing`, `net/http/httptest` и `github.com/golang/mock/gomock`.

В приложении используется специальные ошибки. Код ошибки имеет вид 50.х.х, где 50.0.х - ошибка на уровне чтения и обработки конфигцурационного файла, 50.1.х - ошибка на уровне базы данных, 50.2.х - ошибка, вызванная работой с rtsp-simple-server.
